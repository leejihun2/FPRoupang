												...
												<div class="best-keyword-group-layer" id="recommendSelect_j" style="display: none; height: 150px; width: 455px;">
													...
													<h5 class="best-keyword-title" style="">주요검색어 바로선택</h5>
														<ul class="best-keyword-group-value" style="width: 450px;">
															<li style="width: 80px"><a href="/journey_List?category=91&location=제주" class="best-keyword-group-item">제주</a></li>
															<li style="width: 80px"><a href="/journey_List?category=91&location=강원" class="best-keyword-group-item">강원</a></li>
															<li style="width: 80px"><a href="/journey_List?category=91&location=부산" class="best-keyword-group-item">부산</a></li>
															<li style="width: 80px"><a href="/journey_List?category=91&location=가평" class="best-keyword-group-item">가평</a></li>
															<li style="width: 80px"><a href="/journey_List?category=91&location=경주" class="best-keyword-group-item">경주</a></li>
														</ul>
														<ul class="best-keyword-group-value" style="width: 450px;">
															<li style="width: 80px"><a href="/journey_List?category=91&location=서울" class="best-keyword-group-item">서울</a></li>
															<li style="width: 80px"><a href="/journey_List?category=91&location=전주" class="best-keyword-group-item">전주 </a></li>
															<li style="width: 80px"><a href="/journey_List?category=91&location=강릉" class="best-keyword-group-item">강릉</a></li>
															<li style="width: 80px"><a href="/journey_List?category=91&location=경기" class="best-keyword-group-item">경기</a></li>
															<li style="width: 80px"><a href="/journey_List?category=91&location=속초" class="best-keyword-group-item">속초</a></li>
														</ul>
													</div>
												</div>
											</div>
