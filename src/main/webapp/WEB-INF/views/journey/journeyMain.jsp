...
<section id="contents" style="width: 1900px;" class="contents">
                    ...
                    <div class="home-search-wizard-wrapper">
                        <div class="search-wizard-container">
                            ...
                            <div class="lodging-search-wizard">
                                <h4 class="wizard-logo"><img
                                        src="//img1a.coupangcdn.com/image/coupang/travel/logo/logo-travel-white.png"></h4>
                                <ul class="wizard-components">
                                        ...
                                        <div class="search-keyword-wrap">
                                            <div class="search-keyword">
                                                <div class="search-keyword-input">
                                                    ...
                                                    <input type="text" class="search-keyword-text" placeholder="국내외 지역명, 숙소명으로 검색"value="">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="wizard-dates">
                                        <div class="date-picker">
                                            <a class="date-picker-input">
                                            <span>3월 7일 (화) - 3월 8일 (수)</span>
                                    ...
                                    <li class="wizard-personnel">
                                        <div class="personnel-selector">
                                        <a class="personnel-selector-input">
                                            <span>성인 2, 아동 0</span><i class="travel-icon icon-caret-down-white"style="width: 12px; height: 7px; background-size: 12px 7px; margin-top: 20px; margin-right: 15px; float: right;">icon </i>
                                        </a>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="info-indicator">
                                <ul class="info-indicators">
                                    ...
                                    <li class="" style="width: 144.444px;"><span class="indicator-bar">&nbsp;</span>
                                        <p class="indicator-description"><i class="icon-dot"></i><span>해외여행 추천! 트래블360</span>
                                        </p>
                                    </li>
                                    <li class="" style="width: 144.444px;"><span class="indicator-bar">&nbsp;</span>
                                    ...
                                    <li class="" style="width: 144.444px;"><span class="indicator-bar">&nbsp;</span>
                                        <p class="indicator-description"><i class="icon-dot"></i><span>쿠키트래블</span></p>
                                    </li>
                                    <li class="" style="width: 144.444px;"><span class="indicator-bar">&nbsp;</span>
                                        <p class="indicator-description"><i class="icon-dot"></i><span>단독 특가 펜션</span></p>
                                    </li>
                                    <li class="" style="width: 144.444px;"><span class="indicator-bar">&nbsp;</span>
                                        <p class="indicator-description"><i class="icon-dot"></i><span>하나투어 해외여행</span></p>
                                    </li>
                                    <li class="" style="width: 144.444px;"><span class="indicator-bar">&nbsp;</span>
                                        <p class="indicator-description"><i class="icon-dot"></i><span>금호리조트 4개 지점</span></p>
                                    </li>
                                    <li class="" style="width: 144.444px;"><span class="indicator-bar">&nbsp;</span>
                                        <p class="indicator-description"><i class="icon-dot"></i><span>프리미엄 스테이</span></p>
                                    </li>
                                    <li class="" style="width: 144.444px;"><span class="indicator-bar">&nbsp;</span>
                                        <p class="indicator-description"><i class="icon-dot"></i><span>쿠팡펫여행</span></p>
                                    </li>
                                </ul>
                            </div>
                        </div>
