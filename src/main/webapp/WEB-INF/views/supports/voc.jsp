...
<div class="container" style="background: white;">
	...
	<s:authentication property="name" var="name" />
		...
		<div class="sc-so9ho9-0 krqLio">
			...
			<div>
				<span class="i18n-wrapper">루팡을 이용하면서 느끼신 불편사항이나 바라는 점을 알려주세요.<br>고객님의
					소중한 의견으로 한 뼘 더 자라는 쿠팡이 되겠습니다.
				</span>
			</div>
			<div class="sc-so9ho9-2 CijJk">ceo@roupang.com</div>
			<div class="sc-so9ho9-3 dBPfIJ">문의량이 많아 답변은 24시간 이상 소요될 수 있습니다.</div>
		</div>
		<form name="writeFrm" method="post" onsubmit="return writeValidate(this);" action="<c:url value="/supports/vocAction.do" />" >
			<div class="sc-1uwr20l-0 fGSwLE">
				<div class="sc-2u5cmp-0 ycZdw">
						<select class="sc-46148w-0 cfScjT" class="sc-46148w-1 kplpza" name="title" value="배송관련문의">
					...
					<div class="sc-1dq8ai8-0 ljlKLR">
						...
						<div class="sc-1dq8ai8-1 ddFwWo">
							<svg width="16" height="16" focusable="false" viewBox="0 0 20 20" aria-hidden="true" role="presentation" style="fill:#aaaaaa">
							<path class="xxxxx" fill="#aaaaaa" d="M16.667 2.155l1.178 1.178L11.178 10l6.078 6.077.59.59-1.18 1.178-.589-.59L10 11.179l-6.667 6.667-1.178-1.178L8.82 10 2.744 3.923l-.59-.59 1.18-1.178.589.59L10 8.82l6.667-6.666z"></path></svg>
						</div> 
					</div>
				...
				<div class="sc-1wpxynf-0 iSxnmm">
					<textarea placeholder="의견을 남겨주세요 ※ 문의 답변은 이메일 또는 고객센터>문의내역에서 확인 가능합니다. 전화 연락이 필요하실 경우 [전화필요]를 입력해주세요. ※ 내용 본문과 이미지에 고객님의 개인정보(주민번호 등)가 포함되지 않도록 주의해주세요." class="sc-1wpxynf-1 jOGUyo"></textarea>
					<div class="sc-1ov8bm8-0 eaRLIr">
						<div class="sc-1ov8bm8-1 htfEmI">
							<svg width="20" height="20" focusable="false" viewBox="0 0 18 18"
							...
							<span>이미지 첨부</span><span>20Mb이내 / jpg, png, bmp, gif 만 가능</span><span>0개
								/ 최대 3개</span>
