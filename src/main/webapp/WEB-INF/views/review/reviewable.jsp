			...
			<form name="writeFrm" method="post"
				...
				<div class="my-review__writable js_reviewWritableListContainer">
					...
					<div class="my-review__writable__list-container"
							...
							<li class="my-review__writable__list">
								<div class="my-review__writable__image-wrap">
									<img class="my-review__writable__image"
										...
										title="몽베스트 생수, 2L, 24개" alt="몽베스트 생수, 2L, 24개">
								</div>
								<div class="my-review__writable__content-wrap">
									<div class="my-review__writable__content-title">몽베스트 생수,
										2L, 24개</div>
									<div class="my-review__writable__content">몽베스트 생수, 2L,
										24개</div>
									<div class="my-review__writable__date">2023.03.16 배송</div>
								</div>
                       ...
                       &quot;vendorItemId&quot; : &quot;72921550416&quot;}" onclick="location.href='review.do'">
							...
							<li class="my-review__writable__list">
								<div class="my-review__writable__image-wrap">
									<img class="my-review__writable__image"
										src="https://thumbnail6.coupangcdn.com/thumbnails/remote/250x250ex/image/retail/images/1646360826659406-6eb54a79-dabf-4767-a50a-38c8478776a6.jpg"
										title="샤바스 매일쓰는 데일리 샤워타월 파스텔 4p, 핑크, 옐로우, 블루, 바이올렛, 1세트"
										alt="샤바스 매일쓰는 데일리 샤워타월 파스텔 4p, 핑크, 옐로우, 블루, 바이올렛, 1세트">
								</div>
								<div class="my-review__writable__content-wrap">
									<div class="my-review__writable__content-title">샤바스 매일쓰는
										데일리 샤워타월 파스텔 4p, 핑크, 옐로우, 블루, 바이올렛, 1세트</div>
									<div class="my-review__writable__content">샤바스 매일쓰는 데일리
										샤워타월 파스텔 4p, 핑크, 옐로우, 블루, 바이올렛, 1세트</div>
									<div class="my-review__writable__date">2023.02.16 배송</div>
								</div>
								<div class="my-review__writable__btn-wrap">
									<button
										class="my-review__writable__write-btn js_reviewWritableWriteBtn"
										type="button"
										data-reference="{&quot;completedOrderVendorItemId&quot; : &quot;7608156254&quot;,
                       &quot;productId&quot; : &quot;237181715&quot;,
                       &quot;deliveryDate&quot; : &quot;2023-02-16&quot;,
                       &quot;vendorItemId&quot; : &quot;4898821289&quot;}">
										<span class="my-review__writable__write-btn-text">리뷰
											작성하기</span>
									</button>
									<a href="javascript:void(0);"
										class="my-review__writable__review-hide-btn js_reviewWritableHideBtn"
										data-completed-order-vendor-item-id="7608156254">숨기기</a>
								</div>
							</li>
						</ul>
					</div>
