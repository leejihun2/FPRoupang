...
<footer id="footer" class="footer_new">
    ...
    <div class="footer-layer2">
        <h1><img style="width: 140px;" src="../images/roupang 흑백.png"></h1>
        <div class="footer-content">
            <address>
                상호명 및 호스팅 서비스 제공 : 루팡(주)<br />
                대표이사 : 조용민,이지훈<br />
                서울시 종로구 관철동 <br />
                사업자 등록번호 : 573-05-02011 <br />
                통신판매업신고 : 2021-서울종로<br />
            ...
            <div class="contact-info">
                <a href="https://csmessenger.coupang.com/cs-center/chat/main" class="call-center" title="365 고객센터">
                    ...
                    <em>1577-7011 (유료)</em>
                    서울시 종로구 관철동<br />
                    <span class="contact-fax">email : help@roupang.com</span>
                </a>
            </div>
            <p class="safe-service">
                <strong>하나은행 채무지급보증 안내</strong><br />
        <span>
